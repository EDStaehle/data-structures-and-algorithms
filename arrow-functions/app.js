...
// *** as far as I have read arrow functions cannot be used as constructors or methods****//
// TODO: Uncomment the following line of code to see the output in the browser console
...
Student.courseNam = () => `This student is enrolled in Code 301`;
console.log(Student.courseNam());
// TODO: Uncomment the following line of code to see the output in the browser console
...
// this is refereing to the new object created with the constructor on line 165
// 2. What is "this" when joe.scopeArrow() is invoked?
//this for the scope arrow is the class itself not the function
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions cannot use the syntax this because an arrow functions clas field closes over the this and it doesnt read the data it reads on the class.
